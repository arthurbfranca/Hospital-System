...
public class DoctorPatientsView extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DoctorPatientsView frame = new DoctorPatientsView();
	...
	public DoctorPatientsView() {
		...
		/******** TODO: List patient names here that the are assigned to this specific doctor who
		 * signed in. This string will be used as the String to show names into the pane.
		 * Might be able to use appointments JSON file, although we would need to iterate
		 * through all of them, unless we sort the appointments by doctors. This might mean changes
		 * in the patients' accounts JSON. Whatever doctor they're assigned with, it must be listed there.
		 */

...
public class DoctorAppointmentView extends JFrame {
		...
		/*
		 ...
		 //TODO: gotta set the second one invisible
		...
		//Currently: appointment by appointment.
		NextButton.setVisible(true);	//redundant if already enabled, I expect no harm out of that FIXME: possible bug if it toggles
		viewAppointment(PatientName, AppointmentDate, AppointmentTime, Department, AppointmentType, doctor, counter-=1);
		viewAppointment(PatientName2, AppointmentDate2, AppointmentTime2, Department2, AppointmentType2, doctor, counter);
		if(counter == 0){
...
*/
	...
	//Note: there is some unecessary recursion across the this method and the two above, in fact, they are not needed as individual methods, however,
